...
Для демонстрации работы приложения используются mock-изображения товаров, которые можно скачать по ссылке:

[Скачать mock-изображения (product-images.zip)](https://github.com/sugrobov/fakeStore/raw/master/product-images.zip)
